...
{{/*
Generate the Json Stream CR viewer cluster role name
*/}}
{{- define "app.clusterRole.jsonStreamViewer" -}}
{{- if .Values.rbac.clusterRole.jsonStreamViewer.nameOverride }}
{{- .Values.rbac.clusterRole.jsonStreamViewer.nameOverride }}
{{- else }}
...
*/}}
{{- define "app.clusterRole.jsonStreamEditor" -}}
{{- if .Values.rbac.clusterRole.jsonStreamEditor.nameOverride }}
{{- .Values.rbac.clusterRole.jsonStreamEditor.nameOverride }}
{{- else }}
