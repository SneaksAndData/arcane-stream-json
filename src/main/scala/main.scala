...
object main extends ZIOAppDefault:
  ...
  val blobSourceLayer: ZLayer[PluginStreamContext & S3BlobStorageService, Throwable, BlobListingJsonStreamingSource[
    S3StoragePath
  ]] =
    s3ReaderLayer >>> DefaultNameGenerator.layer >>> BlobListingJsonStreamingSource.getS3Layer(context =>
